    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('label', models.TextField(blank=True, default='', null=True, verbose_name='用例标签')),
                ('case_hash', models.CharField(default='', max_length=200, unique=True, verbose_name='用例hash')),
