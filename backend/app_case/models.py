...
class TestCaseTemp(models.Model):
    """
    测试用例备份表
    """
    project = models.ForeignKey(Project, on_delete=models.CASCADE)
    file_name = models.CharField("文件名", max_length=500, null=False, default="")
    class_name = models.CharField("类名", max_length=200, null=False, default="")
